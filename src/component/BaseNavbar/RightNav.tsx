        ...
        <>
            {
                !session ?
                    ...
                    : <div className="flex items-center">
                        <BaseIcon className="hidden lg:block m-4 cursor-pointer" name="heart" color="text-white" />
                        <BaseIcon className="hidden lg:block m-4 cursor-pointer" name="cart" color="text-white" />
